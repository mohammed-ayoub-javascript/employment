...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full font-sans md:px-10" ref={containerRef} dir="rtl">
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-4 max-w-4xl text-right">
          كيف تحصل على اول وظيفة لك في منصة وظفني
        </h2>
        <p className="text-neutral-700 text-sm md:text-base max-w-sm text-right">
          منصتنا توفر هذا وبأفضل طريقة
        </p>
      </div>
